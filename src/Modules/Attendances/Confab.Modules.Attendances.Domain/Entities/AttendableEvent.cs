...
public class AttendableEvent : AggregateRoot<AttendableEventId>
{
    ...
    public AttendableEvent(AttendableEventId id, ConferenceId conferenceId, DateTime from, DateTime to, IEnumerable<Slot> slots = null)
    {
        Id = id;
    ...
    public Attendance Attend(Participant participant) // It could exists as a service domain
    {
        if (!_slots.Any())
        {
